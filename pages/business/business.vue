<template>
	<view class="container">
		...
		<image class="add_image" src="../../static/add_seller_btn.png" @click="addBusiness"></image>
	</view>
</template>
		...
		methods: {
			...
			async getData(){
				...
				const res = await userList({
					page,page_size,sub_id,role,name
				})
				if(page==1){
			...
			toDetail(e) {
				this.user_id = e
				uni.navigateTo({
					url:`../businessDetail/businessDetail?id=${this.user_id}`
				})
			},
			addBusiness() {
				uni.navigateTo({
